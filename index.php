<?php
    ...
    if (isset($_GET['login'])) {
         $login = $_GET['login'];
         $mdp = $_GET['password'];
         $query = "SELECT * FROM `user` WHERE login  = '$login' AND pwd = '$mdp'";
         //var_dump($query);
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">PRESENCE</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small text-danger"><?=$msg?></p>
                  </div>
                  ...
                  <form class="row g-3 needs-validation" method="get" action="#" novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <div class="invalid-feedback">Entre le nom d'utilidateur.</div>
                      </div>
                    </div>
                    <div class="col-12">
              ...
              <div class="credits">
                ...
                Designed by <a href="https://kadilabrdc.tech/">kadilab</a>
              </div>
